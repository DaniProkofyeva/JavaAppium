...
public class MainPageObject {
    ...
    public void testTextSearchResults(String locator, String text, String error_text)
    {
    ...
    public List<WebElement> waitForNumberOfSeveralElements(String locator, int number, String errorMessage, long timeoutInSeconds) {
        By by = this.getLocatorByString(locator);
    ...
    public void assertElementNotPreset(String locator, String error_message) {
    ...
    public boolean isElementLocatedOnTheScreen(String locator) {
        int element_location_by_y = this.waitForElementPresent(
                locator, String.format("Cannot find element by locator"), 1)
                .getLocation()
                .getY();
